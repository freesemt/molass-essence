...
In this book, the order of description is chosen for the ease of theoretical understanding, and is not the same as that of real analysis procedure. To make that diffence clearer, we give here a brief description of the latter, as well as to declare the current coverage of `Molass Library` there.
